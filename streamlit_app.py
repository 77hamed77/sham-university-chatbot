...
with st.sidebar:
    ...
    st.markdown("<h3 style='color: #ddb892;fnt-family: 'Cairo', sans-serif !important;'> Ahmed Al-Zain & Hamid Al-Marei</h3>", unsafe_allow_html=True)
    st.markdown("<h3 style='color: #9cc6e4;fnt-family: 'Cairo', sans-serif !important;'>بإشراف الدكتورة هنادي العبدالله ✨</h3>", unsafe_allow_html=True)
